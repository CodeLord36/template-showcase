    ...
    <header className="bg-background sticky top-0 z-50 border-b border-border">
      <div className="container flex items-center justify-between py-4">
        ...
        <div className="flex items-center gap-4">
          <button className="text-foreground hover:text-secondary transition-colors" aria-label="Search">
          ...
          <button className="relative text-foreground hover:text-secondary transition-colors" aria-label="Cart">
